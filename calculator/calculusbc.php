...
$js = "../js/calculusbc.js";
$css = "../css/style.css";
$affiliate = '<iframe style="width:120px;height:240px;margin-left:calc(50% - 60px);margin-top:150px;" marginwidth="0" marginheight="0" scrolling="no" frameborder="0" src="//ws-na.amazon-adsystem.com/widgets/q?ServiceVersion=20070822&OneJS=1&Operation=GetAdHtml&MarketPlace=US&source=ac&ref=tf_til&ad_type=product_link&tracking_id=spere-10-20&marketplace=amazon&region=US&placement=0804126135&asins=0804126135&linkId=SAS67WV2M4NCX6GU&show_border=true&link_opens_in_new_window=true"></iframe>';
$content = '
	<h2>Calculus BC <img src="../images/Calc.png" alt="calc"></h2>
