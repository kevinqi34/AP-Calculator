	...
	<div id="calculate">
   		...
   		<h3>Enter your scores below</h3>
			...
			<p><label>Long FRQ Score (%)</label></p>
				<p><input type="range" id="FRQ1" min="0" step="1" max="100" ontouchend="slidervalue(\'FRQ1\',\'FRQ2\'), calculate();" onmouseup="slidervalue(\'FRQ1\',\'FRQ2\'), calculate();"/><input type="number" min="0" max="100" step="1" id="FRQ2" value="50" style="width: 50px;" onchange="slidervalue(\'FRQ2\',\'FRQ1\'), calculate();"/>/100</p>
			<p><label>Short FRQ1 Score (%)</label></p>
				<p><input type="range" id="SRQ1" min="0" step="1" max="100" ontouchend="slidervalue(\'SRQ1\',\'SRQ11\'), calculate();" onmouseup="slidervalue(\'SRQ1\',\'SRQ11\'), calculate();"/><input type="number" min="0" max="100" step="1" id="SRQ11" value="50" style="width: 50px;" onchange="slidervalue(\'SRQ11\',\'SRQ1\'), calculate();"/>/100</p>
