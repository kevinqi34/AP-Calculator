...
$js = "../js/physics1.js";
$css = "../css/style.css";
$affiliate = '<iframe style="width:120px;height:240px;margin-left:calc(50% - 60px);margin-top:150px;" marginwidth="0" marginheight="0" scrolling="no" frameborder="0" src="//ws-na.amazon-adsystem.com/widgets/q?ServiceVersion=20070822&OneJS=1&Operation=GetAdHtml&MarketPlace=US&source=ac&ref=tf_til&ad_type=product_link&tracking_id=spere-10-20&marketplace=amazon&region=US&placement=0804126216&asins=0804126216&linkId=5SQKFBXY3MA4QCH6&show_border=true&link_opens_in_new_window=true"></iframe>';
$content = '
	<h2>Physics 1<img src="../images/Physics.png" alt="Physics"></h2>
<div id="calculator">
	...
	<div id="calculate">
			...
			<p><label>Short Free Response Score</label></p>
				<p><input type="range" id="SFRQ" min="0" step="1" max="21"  onmouseup="slidervalue(\'SFRQ\',\'SFRQ1\'), calculate();" ontouchend="slidervalue(\'SFRQ\',\'SFRQ1\'), calculate();"/><input type="number" min="0" max="21" step="1" id="SFRQ1" value="10" style="width: 50px;" onchange="slidervalue(\'SFRQ1\',\'SFRQ\'), calculate();"/>/21</p>
