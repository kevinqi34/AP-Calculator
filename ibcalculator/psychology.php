...
$js = "../js/ibpsychology.js";
$css = "../css/styleib.css";
$affiliate = '<iframe style="width:120px;height:240px;margin-left:calc(50% - 60px);margin-top:150px;" marginwidth="0" marginheight="0" scrolling="no" frameborder="0" src="//ws-na.amazon-adsystem.com/widgets/q?ServiceVersion=20070822&OneJS=1&Operation=GetAdHtml&MarketPlace=US&source=ac&ref=tf_til&ad_type=product_link&tracking_id=spere-10-20&marketplace=amazon&region=US&placement=0198389965&asins=0198389965&linkId=RXE2SYMQL6OXMJDP&show_border=true&link_opens_in_new_window=true"></iframe>';
$content = '
<h2>Psychology HL/SL<img src="../images/Brain.png" alt="Brain"></h2>
...
<div id="calculator">
	...
	<div id="calculate">
			...
			<p><label>Paper 1 Score</label></p>
				<p><input type="range" id="P1" min="0" step="1" max="52" onmouseup="slidervalue(\'P1\',\'P11\'), calculate();" ontouchend="slidervalue(\'P1\',\'P11\'), calculate();"/><input type="number" min="0" max="52" step="1" id="P11" value="26" style="width: 40px;" onchange="slidervalue(\'P11\',\'P1\'), calculate();"/>/52</p>
			...
			<p><label>Paper 3 Score</label></p>
				<p><input type="range" id="P3" min="0" step="1" max="30" onmouseup="slidervalue(\'P3\',\'P33\'), calculate();" ontouchend="slidervalue(\'P3\',\'P33\'), calculate();"/><input type="number" min="0" max="30" step="1" id="P33" value="15" style="width: 40px;" onchange="slidervalue(\'P33\',\'P3\'), calculate();"/>/30</p>
			<p><label>Internal Score</label></p>
				<p><input type="range" id="IS" min="0" step="1" max="25"onmouseup="slidervalue(\'IS\',\'IS2\'), calculate();" ontouchend="slidervalue(\'IS\',\'IS2\'), calculate();"/><input type="number" min="0" max="25" step="1" id="IS2" value="12" style="width: 40px;" onchange="slidervalue(\'IS2\',\'IS\'), calculate();"/>/25</p>
