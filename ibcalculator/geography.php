...
$css = "../css/styleib.css";
$content = '
<h2>Geography HL/SL<img src="../Globe.png" alt="Globe"></h2>
...
<div id="calculator">		
	...
	<div id="calculate">
			...
			<p><label>Paper 1 Score</label></p>
				<p><input type="range" id="P1" min="0" step="1" max="50" onmouseup="slidervalue(\'P1\',\'P11\'), calculate();" ontouchend="slidervalue(\'P1\',\'P11\'), calculate();"/><input type="number" min="0" max="50" step="1" id="P11" value="25" style="width: 40px;" onchange="slidervalue(\'P11\',\'P1\'), calculate();"/>/50</p>
			<p><label>Paper 2 Score</label></p>
				<p><input type="range" id="P2" min="0" step="1" max="80" onmouseup="slidervalue(\'P2\',\'P22\'), calculate();" ontouchend="slidervalue(\'P2\',\'P22\'), calculate();"/><input type="number" min="0" max="80" step="1" id="P22" value="40" style="width: 40px;" onchange="slidervalue(\'P22\',\'P2\'), calculate();"/>/80</p>	
			<p><label>Internal Score</label></p>
				<p><input type="range" id="IS" min="0" step="1" max="30"onmouseup="slidervalue(\'IS\',\'IS2\'), calculate();" ontouchend="slidervalue(\'IS\',\'IS2\'), calculate();"/><input type="number" min="0" max="30" step="1" id="IS2" value="15" style="width: 40px;" onchange="slidervalue(\'IS2\',\'IS\'), calculate();"/>/30</p>
