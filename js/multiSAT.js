...
var vers = $('#version').val();
	...
	if (vers == "Pos2012") {
		...
		$('#calculate, #score3, #score3p, #p1').css("display","none");
		$('#calculate2, #p2').css("display","block");
		...
		$('#calculate, #score3, #score3p, #p1').css("display","block");
		$('#calculate2, #p2').css("display","none");
		calculate();
